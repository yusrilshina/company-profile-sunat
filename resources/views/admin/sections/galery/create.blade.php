                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header rounded-top-3 bg-secondary">
                            <h4 class="text-white">Pengisian Galery</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('dashboard-galery.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="umur" class="form-control @error('umur') is-invalid @enderror" id="umur"
                                        placeholder="Masukkan Umur (Tahun)" value="{{ old('umur') }}"  />
                                        @error('umur')
                                        <small  class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                </div>
